...
import com.levog.flapp.ui.screens.healthsleep.start.components.InformationSleepIntervalAndDurationElement
import java.time.LocalDate

@Composable
fun InformationSleepDurationLatestDaysElement(
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(
                ...
                InformationSleepDurationElement(
